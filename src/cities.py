...
CITIES_LIST = [
    # Grupo 1 - Semana 1: São Paulo Capital + Grande SP + RJ + MG
    ("sao-paulo", "sp"),
    ("guarulhos", "sp"),
    ...
    # Grupo 2 - Semana 2: Interior SP + Sul
    ("campinas", "sp"),
    ...
    # Grupo 4 - Semana 4: Norte + Centro-Oeste
    ("manaus", "am"),
    ("belem", "pa"),
    ("ananindeua", "pa"),
    ("santarem", "pa"),
    ...
    # Grupo 5 - Semana 5: Cidades médias complementares
    ("florianopolis", "sc"),
    ("joinville", "sc"),
    ("blumenau", "sc"),
    ("sao-jose", "sc"),
...
def build_city_url(city, state):
    """
    Constrói URL do GetNinjas para uma cidade
    
    Args:
        city: Nome da cidade (formato URL: sao-paulo)
        state: Sigla do estado (sp, rj, etc)
    
    Returns:
        URL completa
    """
    from config import BASE_URL_GETNINJAS
    return f"{BASE_URL_GETNINJAS}/{city}-{state}"
